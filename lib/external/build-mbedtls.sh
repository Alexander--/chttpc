...
export CFLAGS="-D__ANDROID_API__=15 -pipe -Os -g0 -fuse-ld=bfd -fpic -flto -fomit-frame-pointer -fvisibility=hidden -ffunction-sections -fno-exceptions -fno-unwind-tables -fno-asynchronous-unwind-tables -frandom-seed=frkj23tfje4 -Werror=date-time"
